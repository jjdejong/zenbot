...
module.exports = {
  name: 'srsi_bollinger',
  description: 'Stochastic RSI Bollinger Band Strategy',
  ...
  getOptions: function () {
    ...
    this.option('srsi_k_buy', 'K must be below this before buying', Number, 40)
